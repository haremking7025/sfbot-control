...
class AppWindowMixin:
    ...
    def on_close_window(self):
        ...
        self._save_settings()
        # ปิด session ก่อนออก = ค่าถาวร (ทำเสมอ ไม่มี toggle ให้ปิดได้) — ล้าง
        # session ทั้งหมดในหน่วยความจำก่อนออกโปรแกรม ไม่เหลือค้าง (คุกกี้บนดิสก์
        # ยังอยู่ → รอบหน้าเปิดมาล็อกอินผ่านคุกกี้ได้ไวเหมือนเดิม) ทำแบบ sync ตรงนี้
