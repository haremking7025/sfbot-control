...
| 📦 ฝาก/เบิก | ดู/เลือกไอเทม (กรองหมวด, หมดอายุ, ลบได้) + ฝาก/เบิก/ลบทั้งหมด — หลายบัญชีพร้อมกัน, ปิดเซสชันอัตโนมัติหลังจบรอบ |
...
**สำหรับผู้ใช้** — แท็บ ⚙ ตั้งค่า → **ย้อนกลับเวอร์ชัน** (`core/rollback.py`): เลือกรุ่นจากรายการ
ที่ตรวจลายนิ้วมือได้ กดติดตั้งครั้งเดียว โปรแกรมจะดาวน์โหลด → ตรวจขนาด + SHA-256 +
ชนิดไฟล์ → เปิดตัวติดตั้งแล้วปิดตัวเอง · รุ่นที่ยืนยันไม่ได้จะกดไม่ได้ พร้อมบอกเหตุผลบนจอ
รุ่นยุคก่อนเปลี่ยนโฟลเดอร์ข้อมูล (`< 1.3.6`) จะมีช่องติ๊ก **คัดลอกบัญชี/Cookie/ค่าตั้ง**
(เปิดไว้ให้) เพื่อย้ายข้อมูลชุดปัจจุบันไปให้รุ่นเก่าเห็นด้วย — สำรองโฟลเดอร์เดิมไว้ก่อนเสมอ
ติ๊กออกได้ถ้าต้องการเริ่มจากข้อมูลว่าง
หลังย้อนเสร็จจะ **กันอัปเดต** รุ่นที่เพิ่งถอยหนีไม่ให้เด้งกลับมา (ล้างเองได้ในหน้าต่างนั้น)

**สำหรับผู้ดูแล** — ตัวอัปเดตเสนอเฉพาะรุ่นที่ใหม่กว่า ⇒ แค่ชี้ `update.json` ไปรุ่นเก้าไม่มีผลกับลูกค้า
